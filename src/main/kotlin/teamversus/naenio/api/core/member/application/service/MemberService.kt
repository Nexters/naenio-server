package teamversus.naenio.api.core.member.application.service

import org.springframework.stereotype.Service
import reactor.core.publisher.Mono
import reactor.kotlin.core.publisher.switchIfEmpty
import teamversus.naenio.api.core.member.application.JwtTokenUseCase
import teamversus.naenio.api.core.member.application.LoginUseCase
import teamversus.naenio.api.core.member.application.MemberExistByNicknameUseCase
import teamversus.naenio.api.core.member.application.MemberSetNicknameUseCase
import teamversus.naenio.api.core.member.domain.model.AuthServiceType
import teamversus.naenio.api.core.member.domain.model.MemberRepository
import teamversus.naenio.api.core.member.port.member.ExternalMemberLoadPort
