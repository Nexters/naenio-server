package teamversus.naenio.api.command.member.application.service

import org.springframework.stereotype.Service
import reactor.core.publisher.Mono
import reactor.kotlin.core.publisher.switchIfEmpty
import teamversus.naenio.api.command.member.application.JwtTokenUseCase
import teamversus.naenio.api.command.member.application.LoginUseCase
import teamversus.naenio.api.command.member.application.MemberExistByNicknameUseCase
import teamversus.naenio.api.command.member.application.MemberSetNicknameUseCase
import teamversus.naenio.api.command.member.domain.model.AuthServiceType
import teamversus.naenio.api.command.member.domain.model.MemberRepository
